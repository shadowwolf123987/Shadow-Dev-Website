		...
		<div id="content">
			...
			<div class="projectsGrid">
				...
				<div class="projectsDiv" onclick="window.location.href='./projects/WebsterAndHorsfall'">
					<div class="projectsImgDiv">
						<img src="./imgs/projects/WHGroup/home.png" title="Webster and Horsfall Group Website" alt="Webster and Horsfall Group Home Page">
					</div>
				...
				<div class="projectsDiv">
					<div class="projectsImgDiv" onclick="window.location.href='./projects/CertificateCreator'">
						<img src="./imgs/projects/CertificateCreator/home.png" title="Certificate Creator Tool" alt="Certificate Creator Tool">
					</div>
				...
				<div class="projectsDiv">
					<div class="projectsImgDiv" onclick="window.location.href='./projects/AirgunRange'">
						<img src="./imgs/projects/AirGun/home.png" title="Air Gun Range Website" alt="Air Gun Range Website">
					</div>
					<p>Air Gun Range</p>
				</div>
				...
				<div class="projectsDiv">
					<div class="projectsImgDiv" onclick="window.location.href='./projects/GunQuiz'">
						<img src="./imgs/projects/GunQuiz/guess.png" title="Gun Quiz Tool" alt="Gun Quiz Tool">
					</div>
					<p>Gun Quiz</p>
				</div>
				...
				<div class="projectsDiv">
					<div class="projectsImgDiv" onclick="window.location.href='./projects/GamblingGame'">
						<img src="./imgs/projects/GamblingGame/gameplay.png" title="Gambling Game" alt="Gambling Game">
					</div>
